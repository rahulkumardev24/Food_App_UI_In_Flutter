...
import 'package:food_app_ui/screen/restaurant_details_screen.dart';
import 'package:food_app_ui/screen/restaurant_featured_partners_screen.dart';
import 'package:food_app_ui/screen/restaurant_filters_screen.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              SectionTitle(title: "Best Pick", press: () {}),
              const SizedBox(height: 16),
              const MediumCardList(),
              const SizedBox(height: 20),
              SectionTitle(
              ...
              ...List.generate(
                ...
                (index) => Padding(
                  ...
                  child: RestaurantInfoBigCard(
                    ...
                    press: () {
                      Navigator.push(context, MaterialPageRoute(builder: (_)=>AddToOrderScrreen()   ));
                    },
                  ),
                ),
              ),
      ...
      child:
          isLoading
              ...
              : ClipRRect(
                ...
                child: Image.network(
                  "https://i.postimg.cc/PxZ4fxjc/Banner.png",
                ),
              ),
    );
  }
